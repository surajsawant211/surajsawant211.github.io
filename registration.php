...
$query="insert into user values('','$n','$e','$pass','$hob','$dob',now())";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<td><input type="radio" name="quest2" value="5" required>IT
					<input type="radio" name="quest2" value="4">COMS
					<input type="radio" name="quest2" value="3">MECH
					<input type="radio" name=" quest2" value="2">ELEC
					<input type="radio" name="quest2" value="1">CIVIL</td>
				</tr>
