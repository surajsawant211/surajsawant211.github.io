    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">DMCE Alumni</a>
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>WELCOME TO DMCE</h2>
				Established in 1988 Datta Meghe College of Engineering is one of the reputed institutions in Navi Mumbai under the umbrella of Nagar Yuwak Shikshan Sansthas, Airoli. The tremendous growth of the college within a span of 30 years depicts the sincerity and hardship of the management and the staff.
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed by DMCE students. DMCE Website : <a href="https://dmce.ac.in">dmce.ac.in</a> </span>
	</div>
    <!-- jQuery -->
